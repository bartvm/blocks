...
def main(seq_u, seq_y, n_h, n_y, n_epochs):
    ...
    predict = theano.function(inputs = [u, ],
                              outputs = y_hat)
    ...
    ax1.annotate('Input data point', xy=(2, test_u[2,0,0]), xytext=(2, test_u[2,0,0]+1),
                 arrowprops=dict(facecolor='black', shrink=0.05))

    ax2.annotate('Output data point (Same point but with 2 time_steps delay)', xy=(4, test_y[4,0,0]), xytext=(4, test_y[4,0,0]+1),
                 arrowprops=dict(facecolor='black', shrink=0.05))
